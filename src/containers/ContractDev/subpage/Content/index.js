                ...
                <Col className="top" span={16}>
                    ...
                    <Row type="flex" justify="center" className="chains-intent">
                        <Col span={18} className="content">
                            <div className="top">
                                <div><text className="num"></text>有技术能力的用户可参与加入楼兰开发者计划，按照平台提供的智能合约模板与接口标准开发智能合约。</div>
                                <div><text className="num"></text>合约完成后可发布到合约商店中出售。</div>
                                <div><text className="num"></text>链上企业将在商店中购买并支付区块链数字货币URT。平台不收取任何费用。</div>
                                <div><text className="num"></text>智能合约采用GOLANG语言开发，开发前请确认具备相关知识。</div>
                            </div>
